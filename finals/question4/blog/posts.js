...
function PostsDAO(db) {
    ...
    this.getPostByPermalink = function(permalink, callback) {
        ...
        posts.findOne({'permalink': permalink}, function(err, post) {
            ...
            //console.log("Here's the post object:");
            //console.log(post);
    ...
    this.incrementLikes = function(permalink, post, comment_ordinal, callback) {
        "use strict";
        ...
        //console.log("In posts.incrementLikes. Here is the post:");
        //console.dir(post);

        //console.log("Count for " + comment_ordinal + " comment like: " + post.comments[comment_ordinal].num_likes);

        var selector = {};
        var numLikes = 1;

        if (post.comments[comment_ordinal]) {
            numLikes = post.comments[comment_ordinal].num_likes + 1;
        }

        console.log("New num_likes count: " + numLikes);

        selector['comments.' + comment_ordinal + '.num_likes'] = numLikes;
        console.dir(selector);
        console.log("Post id: " + post._id);

        posts.update({"_id": post._id}, {$set: selector}, callback);
